...
const NIX_CONFIG_HEADER: &str = r#"# Generated by https://github.com/NixOS/experimental-nix-installer
# See `/nix/nix-installer --version` for the version details.
"#;

const NIX_CONFIG_FOOTER: &str = "!include nix.custom.conf";

pub(crate) const CUSTOM_NIX_CONFIG_HEADER: &str = r#"# Written by https://github.com/NixOS/experimental-nix-installer
