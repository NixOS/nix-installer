...
sed -i "s@https://artifacts.nixos.org/experimental-installer@$DEST_INSTALL_URL@" "$DEST/nix-installer.sh"
sed -i "s@https://artifacts.nixos.org/experimental-installer@https://artifacts.nixos.org/experimental-installer/rev/$GIT_ISH@" "$GIT_ISH/nix-installer.sh"
